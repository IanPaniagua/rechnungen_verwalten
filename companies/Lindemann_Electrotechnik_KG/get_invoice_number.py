...
def extract_invoice_number(text):
    ...
    pattern = r'Rechnung\s+(\d{4}/\d{4})'  # Matches "Rechnung" followed by any non-whitespace characters
...
if __name__ == "__main__":
    folder_path = 'Lindemann_Electrotechnik_KG/invoice'  # Specify the folder containing the PDFs
